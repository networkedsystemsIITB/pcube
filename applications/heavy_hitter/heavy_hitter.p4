...
action set_heavy_hitter_count() {
    modify_field_with_hash_based_offset(custom_metadata.hash_val1, 0,
                                        heavy_hitter_hash1, 16); //dest, base, field_list_calc for hash calc, size of hash
    register_read(custom_metadata.count_val1, heavy_hitter_counter1, custom_metadata.hash_val1); //dest, reg-ref name of reg array, offset of array to get reg 
