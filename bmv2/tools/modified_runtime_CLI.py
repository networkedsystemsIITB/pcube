...
def main():
    ...
    services = RuntimeAPI.get_thrift_services(args.pre)
    services.extend([("simple_switch", SimpleSwitch.Client)])
    ...
    # print "here"
    RuntimeAPI(args.pre, standard_client, mc_client, sswitch_client).cmdloop()
