...
#include "distributed_stateful_load_balancer_merged_s10_sync.p4"
...
action get_switch_flow_count(){
        ...
        register_read(meta.switch_flow5, total_flow_count_register, 5 + 3 - 2);
        register_read(meta.switch_flow6, total_flow_count_register, 6 + 3 - 2);
        register_read(meta.switch_flow7, total_flow_count_register, 7 + 3 - 2);
        register_read(meta.switch_flow8, total_flow_count_register, 8 + 3 - 2);
        register_read(meta.switch_flow9, total_flow_count_register, 9 + 3 - 2);
}
    ...
    action set_switch5_dest_port(){
        register_write(total_flow_count_register, 5 + 3 - 2, meta.switch_flow5 + 1);
        modify_field(standard_metadata.egress_spec, 5 + 3);
    }
    action set_switch6_dest_port(){
        register_write(total_flow_count_register, 6 + 3 - 2, meta.switch_flow6 + 1);
        modify_field(standard_metadata.egress_spec, 6 + 3);
    }
    action set_switch7_dest_port(){
        register_write(total_flow_count_register, 7 + 3 - 2, meta.switch_flow7 + 1);
        modify_field(standard_metadata.egress_spec, 7 + 3);
    }
    action set_switch8_dest_port(){
        register_write(total_flow_count_register, 8 + 3 - 2, meta.switch_flow8 + 1);
        modify_field(standard_metadata.egress_spec, 8 + 3);
    }
    action set_switch9_dest_port(){
        register_write(total_flow_count_register, 9 + 3 - 2, meta.switch_flow9 + 1);
        modify_field(standard_metadata.egress_spec, 9 + 3);
    }
